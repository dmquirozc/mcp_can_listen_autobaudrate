...
void MCP_CAN::mcp2515_modifyRegister(const INT8U address, const INT8U mask, const INT8U data)
{
    SPI.beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
    spi_readwrite(MCP_BITMOD); // modify particular bits of a register.
    spi_readwrite(address);
    spi_readwrite(mask);
    spi_readwrite(data);
    MCP2515_UNSELECT();
...
INT8U MCP_CAN::mcp2515_configRate(const INT8U canSpeed, const INT8U canClock)            
{
    ...
    switch (canClock)
    {
        ...
        switch (canSpeed) 
        {
            ...
            case (CAN_15k6BPS):
            cfg1 = MCP_16MHz_15k625BPS_CFG1;
            cfg2 = MCP_16MHz_15k625BPS_CFG2;
            cfg3 = MCP_16MHz_15k625BPS_CFG3;
            break;
            ...
            case (CAN_32kBPS): 
            cfg1 = MCP_16MHz_32kBPS_CFG1;
            cfg2 = MCP_16MHz_32kBPS_CFG2;
            cfg3 = MCP_16MHz_32kBPS_CFG3;
            break;
            ...
            case(CAN_41k6BPS):
            cfg1 = MCP_16MHz_41k66BPS_CFG1;
            cfg2 = MCP_16MHz_41k66BPS_CFG2;
            cfg3 = MCP_16MHz_41k66BPS_CFG3;
            break;

            case(CAN_44k4BPS):
            cfg1 = MCP_16MHz_44k44BPS_CFG1;
            cfg2 = MCP_16MHz_44k44BPS_CFG2;
            cfg3 = MCP_16MHz_44k44BPS_CFG3;
            break;

            case (CAN_50kBPS):    
            cfg1 = MCP_16MHz_50kBPS_CFG1;                                          //  50Kbps
            cfg2 = MCP_16MHz_50kBPS_CFG2;
            cfg3 = MCP_16MHz_50kBPS_CFG3;
            break;

            case (CAN_53k3BPS):
            cfg1 = MCP_16MHz_53k33BPS_CFG1;
            cfg2 = MCP_16MHz_53k33BPS_CFG2;
            cfg3 = MCP_16MHz_53k33BPS_CFG3;
            break;
            case (CAN_55k5BPS):    
            cfg1 = MCP_16MHz_55k55BPS_CFG1;                                          //  50Kbps
            cfg2 = MCP_16MHz_55k55BPS_CFG2;
            cfg3 = MCP_16MHz_55k55BPS_CFG3;
            break;

            case (CAN_62k5BPS):    
            cfg1 = MCP_16MHz_62k5BPS_CFG1;                                          //  50Kbps
            cfg2 = MCP_16MHz_62k5BPS_CFG2;
            cfg3 = MCP_16MHz_62k5BPS_CFG3;
            break;

            case (CAN_66k6BPS):    
            cfg1 = MCP_16MHz_66k66BPS_CFG1;                                          //  50Kbps
            cfg2 = MCP_16MHz_66k66BPS_CFG2;
            cfg3 = MCP_16MHz_66k66BPS_CFG3;
            break;
            ...
            cfg1 = MCP_16MHz_88k8BPS_CFG1;
            cfg2 = MCP_16MHz_88k8BPS_CFG2;
            cfg3 = MCP_16MHz_88k8BPS_CFG3;
            break;
            ...
            cfg1 = MCP_16MHz_106k66BPS_CFG1;
            cfg2 = MCP_16MHz_106k66BPS_CFG2;
            cfg3 = MCP_16MHz_106k66BPS_CFG3;
            break;

            case (CAN_111k1BPS):                                             // 100Kbps
            cfg1 = MCP_16MHz_111k11BPS_CFG1;
            cfg2 = MCP_16MHz_111k11BPS_CFG2;
            cfg3 = MCP_16MHz_111k11BPS_CFG3;
            break;

            case (CAN_121k2BPS):                                             // 125Kbps
            cfg1 = MCP_16MHz_121k21BPS_CFG1;
            cfg2 = MCP_16MHz_121k21BPS_CFG2;
            cfg3 = MCP_16MHz_121k21BPS_CFG3;
            break;
            ...
            cfg1 = MCP_16MHz_133k33BPS_CFG1;
            cfg2 = MCP_16MHz_133k33BPS_CFG2;
            cfg3 = MCP_16MHz_133k33BPS_CFG3;
            break;

            case (CAN_145k4BPS):                                             // 125Kbps
            cfg1 = MCP_16MHz_145k45BPS_CFG1;
            cfg2 = MCP_16MHz_145k45BPS_CFG2;
            cfg3 = MCP_16MHz_145k45BPS_CFG3;
            break;

            case (CAN_148k1BPS):                                             // 125Kbps
            cfg1 = MCP_16MHz_148k14BPS_CFG1;
            cfg2 = MCP_16MHz_148k14BPS_CFG2;
            cfg3 = MCP_16MHz_148k14BPS_CFG3;
            break;

            case (CAN_160kBPS):                                             // 125Kbps
            cfg1 = MCP_16MHz_160kBPS_CFG1;
            cfg2 = MCP_16MHz_160kBPS_CFG2;
            cfg3 = MCP_16MHz_160kBPS_CFG3;
            break;

            case (CAN_166k6BPS):                                             // 125Kbps
            cfg1 = MCP_16MHz_166k66BPS_CFG1;
            cfg2 = MCP_16MHz_166k66BPS_CFG2;
            cfg3 = MCP_16MHz_166k66BPS_CFG3;
            break;

            case (CAN_181k8BPS):                                             // 125Kbps
            cfg1 = MCP_16MHz_181k81BPS_CFG1;
            cfg2 = MCP_16MHz_181k81BPS_CFG2;
            cfg3 = MCP_16MHz_181k81BPS_CFG3;
            break;
            ...
            cfg1 = MCP_16MHz_222k22BPS_CFG1;
            cfg2 = MCP_16MHz_222k22BPS_CFG2;
            cfg3 = MCP_16MHz_222k22BPS_CFG3;
            break;
            ...
            cfg1 = MCP_16MHz_266k66BPS_CFG1;
            cfg2 = MCP_16MHz_266k66BPS_CFG2;
            cfg3 = MCP_16MHz_266k66BPS_CFG3;
            break;

            case (CAN_320kBPS):                                             // 200Kbps
            cfg1 = MCP_16MHz_320kBPS_CFG1;
            cfg2 = MCP_16MHz_320kBPS_CFG2;
            cfg3 = MCP_16MHz_320kBPS_CFG3;
            break;

            case (CAN_333k3BPS):                                             // 200Kbps
            cfg1 = MCP_16MHz_333k33BPS_CFG1;
            cfg2 = MCP_16MHz_333k33BPS_CFG2;
            cfg3 = MCP_16MHz_333k33BPS_CFG3;
            break;

            case (CAN_400kBPS):                                             // 500Kbps
            cfg1 = MCP_16MHz_400kBPS_CFG1;
            cfg2 = MCP_16MHz_400kBPS_CFG2;
            cfg3 = MCP_16MHz_400kBPS_CFG3;
            break;

            case (CAN_444k4BPS):                                             // 500Kbps
            cfg1 = MCP_16MHz_444k44BPS_CFG1;
            cfg2 = MCP_16MHz_444k44BPS_CFG2;
            cfg3 = MCP_16MHz_444k44BPS_CFG3;
            break;
            ...
            cfg1 = MCP_16MHz_666k66BPS_CFG1;
            cfg2 = MCP_16MHz_666k66BPS_CFG2;
            cfg3 = MCP_16MHz_666k66BPS_CFG3;
            break;
...
** Descriptions:            Public function to set the bps of can bus read
*********************************************************************************************************/
bool MCP_CAN::setBaud(INT8U speed, INT8U clock)
{   
    mcp2515_configRate(speed,clock);
}
/*********************************************************************************************************
